...
## Icon rules (learned 2026-09-17 in hanime-extensions — do not regress here)
...
2. Put the SAME 512px `ic_launcher.png` in **ALL FIVE** buckets
   ...
   is there. Reference implementation: `hanime-extensions/src/all/hanime/res/`
   (all five buckets are the identical 512px file, crisp on both screens).
